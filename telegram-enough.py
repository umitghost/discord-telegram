...
TOKEN = environ.get('6078311816:AAElnzR5QyxrxutW4jWauHP-2mvDmkqQMMY')
...
def main() -> None:
    application = Application.builder().token("6078311816:AAElnzR5QyxrxutW4jWauHP-2mvDmkqQMMY").build()
