...
TOKEN = "MTA3MzUxNjUxOTI0NzU4OTQyNg.GA_jxV.AKwfv1A4P1KVPA08ZOWR-tu4hDnz-fLParkzWs"
...
async def on_ready():
    ...
    activity = discord.Activity(type=discord.ActivityType.playing, name="Telegram Mrx_SmsBot")
